...
var juegoAhorcado = {
                ...
                if (
                    ...
                    if (!self.teclasBloqueadas.includes(teclas[i].letra)) {
                        ...
                        if (self.palabraSeleccionada.includes(teclas[i].letra)) {
                            ...
                            // Mostrar mensaje de pérdida si se agotan los intentos
                            if (self.intentos <= 0) {
                                console.log("Has perdido")
                                console.log("¡Has perdido! La palabra era: " + this.palabraSeleccionada);

                                // Reiniciar el juego después de 5 segundos
                                setTimeout(function () {
                                    juegoAhorcado.inicializar();
                                }, 5000);
                                // Aquí podrías reiniciar el juego o realizar otras acciones
                            }
                        }
                    }
    ...
    ganar: function () {
        ...
        if (!this.dibujarPalabra().includes("_")) {
            // Mostrar mensaje de victoria
            this.mostrarMensajeTemporal("¡Has ganado!");
